...
class ManageReviewController extends Controller
{
    ...
    private $initialReviews = [
        ...
        ['id' => 6, 'product_name' => 'Pelet Maggot', 'reviewer_name' => 'Budi', 'rating' => 3, 'komentar' => 'Butuh perbaikan pengiriman', 'status' => 'pending', 'tanggal' => '14/06/2025', 'product_image' => 'pelet-maggot.jpg'],
    ];
